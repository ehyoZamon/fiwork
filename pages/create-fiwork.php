                ...
                <div class="create-fiwork-container">
                    <div class="create-fiwork-form-container">
                        <div class="create-fiwork-steps-container">
                                        ...
                                        <div class="create-fiwork-step-stage create-fiwork-step-enter-name">
                                            ...
                                            <div class="step-stage-form">
                                                <div class="textarea-container">
                                                    <textarea placeholder="Напишу текст песни" name="fiwork-name" maxlength="170" required></textarea>
                                            ...
                                            <div class="step-stage-form">
                                                <div class="editor-wrapper">
                                                    <div class="editor-container">
                                                        ...
                                                        <!-- Editor -->
                                                        <div id="fiworkDescriptionEditor" spellcheck="true" class="editor" name="fiworkDescriptionEditor"></div>
                                                    </div>
                                            ...
                                            <div class="step-stage-form">
                                                <div class="editor-wrapper">
                                                    <div class="editor-container">
                                                        ...
                                                        <!-- Editor -->
                                                        <div id="fiworkCustomerDescriptionEditor" spellcheck="true" class="editor" name="fiworkCustomerDescriptionEditor"></div>
                                                    </div>
                            ...
                            <form class="create-fiwork-step fiwork-price-and-options-form">
                                <div class="create-fiwork-step-header">
                            ...
                            <form class="create-fiwork-step fiwork-portfolio-form">
                                <div class="create-fiwork-step-header">
                                    <div class="create-fiwork-step-num-container">
                                        4
                                    </div>
                                            ...
                                            <div class="add-works-container">
                                                <div class="add-work-elem">
                                                    ...
                                                    <div class="add-work-elem-loaded-container hidden">
                                                        ...
                                                        <img src="/img/icons/edit-pencil.svg" alt="edit-icon" class="edit-icon"/>
                                                    </div>
                                                </div>
                                                <div class="add-work-elem">
                                                    <img src="/img/icons/green-round-plus.svg" alt="round-plus-icon" class="green-round-plus"/>
...
<script>
    ...
    $(".add-work-modal-container").on("submit",function(e){
        ...
        if(cropper){
            ...
            if($(".fiwork-portfolio-container .add-work-elem .add-work-elem-loaded-container.hidden").length>=2){
                $(".fiwork-portfolio-container .add-work-elem .add-work-elem-loaded-container.hidden").first().removeClass("hidden").find(".work-img").attr("src",result);
            }else{
    ...
    createQuill('#fiworkDescriptionEditor','#fiworkDescriptionToolbar','fiwork-description-char-counter');
    createQuill('#fiworkCustomerDescriptionEditor','#fiworkCustomerDescriptionToolbar','fiwork-customer-description-char-counter','Чтобы выполнить ваш заказ, мне потребуется от вас задание. Опишите, что именно вы хотите получить, какие у вас предпочтения. Пришлите нужные файлы и доступы, если они нужны для выполнения заказа.');
